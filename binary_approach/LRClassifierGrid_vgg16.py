...
from gridsearch_lr import gridsearchLR
...
for i in range(0,500):
    ...
    parametros = {'C':[0.1, 1, 10],'penalty':['none', 'l2']}
    resultGrid = gridsearchLR(parametros, X_train_1,y_train_1,X_val, y_val) 
    print(resultGrid)
    clf = LogisticRegression(C=resultGrid['C'], penalty=resultGrid['penalty'])
