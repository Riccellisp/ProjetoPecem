...
from gridsearch_nb import gridsearchNB
...
for i in range(0,500):
    ...
    resultGrid = gridsearchNB(parametros, X_train_1,y_train_1,X_val, y_val) 
    print(resultGrid)
    clf = GaussianNB(var_smoothing=resultGrid['var_smoothing'])
